...
export function ResumePreview({ resumeData, contentRef, className, preview }: ResumePreviewProps) {
  ...
  return (
    ...
    //             {/* Contact Info Grid */}
    //             <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-resume-sm">
    //               {(city || country) && (
    ...
    //                     </div>
    //                     <span className="text-resume-sm text-gray-500 italic whitespace-nowrap">
    ...
    //                   <span
    //                   key={idx}
    //                   className="px-4 py-2 bg-slate-100 text-slate-700 rounded-lg text-resume-sm font-medium skill-badge hover:bg-slate-200 transition-colors"
    //                   >
    //                   {skill.trim()}
    //                   </span>
    //                 )
