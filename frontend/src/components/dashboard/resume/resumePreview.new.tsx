...
export function ResumePreview({ resumeData, contentRef, className, preview }: ResumePreviewProps) {
  ...
  return (
    <div className={cn(
      ...
      <div className="min-h-screen py-4 flex justify-center items-start relative">
        ...
        {/* Resume Container with Scaling */}
        <div className="transform-gpu origin-top scale-[0.4] xs:scale-[0.5] sm:scale-[0.65] md:scale-100">
          <div className="w-[210mm] bg-white shadow-xl rounded-none print:shadow-none">
